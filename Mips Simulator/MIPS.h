...
private:
	...
	enum WIRES {
		...
		MUXALURES = 11, PCPLUS4 = 12, PCOUT = 14, PCIN = 15, SHIFTLEFT2INST = 16, ZERO = 17, ALUCONTROLRES = 18, FOUR = 19, NULLWIRE = 20, PCREG = 21, MUXPCP4ALU = 22, SL2ALU = 23,
		MUXPCP4ALURES = 24
	};
	...
	void Mux(int busA, int busB, uint32_t select, int output);
	void Mux(SubWire busA, SubWire busB, uint32_t select, int output);
